...
export const colorGroups: { title: string; description: string; tokens: ColorToken[] }[] = [
  {
    ...
    tokens: [
      { name: 'Primary / BG', cssVar: '--btn-primary-bg', value: '#000000', description: 'Default fill' },
      { name: 'Primary / BG Hover', cssVar: '--btn-primary-bg-hover', value: '#262626', description: 'Hover fill' },
      { name: 'Primary / BG Disabled', cssVar: '--btn-primary-bg-disabled', value: '#a3a3a3', description: 'Disabled fill' },
